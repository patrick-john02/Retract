        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Rejected Capstone</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<div class="card-body">
    <table id="example1" class="table table-bordered table-striped">
        ...
        <tbody>
    <tr>
        <td>Online Research Tracking System</td>
    ...
    <tr>
        <td>AI-Based Student Assistance Chatbot</td>
    ...
    <tr>
        <td>IoT-Based Smart Home System</td>
    ...
    <tr>
        <td>Blockchain Secured E-Voting System</td>
